...
public class vdetalle_ingreso {
    ...
    public vdetalle_ingreso(int id_detalle_ingreso, int id_ingreso, String id_articulo, Double precio_compra, Double precio_venta, int stock_inicial, int stock_actual) {
